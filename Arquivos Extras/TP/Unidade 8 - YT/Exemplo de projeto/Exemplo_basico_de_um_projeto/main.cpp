...
int main()
{
	...
	while(aux != 0)
	{
		cout << "Fiz esse pequeno projeto para tentar mostrar pra vocês algumas formas de utilizar manipulação "
			<< "\nde arquivos, tratamento de exceções, sobrecargas e o contêiner vector em seus projetos. Espero "
			<< "\najude vocês." << endl;
		
		cout << "\nEste projeto consiste em uma lista de objetos que armazenam dados de uma pessoa."
			<< "\nEscolha uma das opções abaixo para a manipulação dessa lista: "
		...
		switch(opcao)
		{
			...
			case 7:
			{
				cout << "Lista de pessoas ordenada por nome em ordem alfabética: " << endl << endl;
