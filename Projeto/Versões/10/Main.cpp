...
int main( ){
	...
	cin>>opcao1;
		...
		if(opcao1==1){
			...
			cout<<"11 - Adicionar unidade a um produto exixtente"<<endl;
				...
				switch(opcao){
					...
					case 9:{
						...
						if(estoque.EfetuarVendaUnd(codigo, quantidade)){
							cout << "Obrigada pro comprar" << endl;
						}
						else{
							cout << "Nao foi possivel vender."<< endl;
						}
						system("pause");
						system("cls");
						break;
					...
					case 11:{
						...
						cout<<"Entre com a quantidade e o codigo do produto"<<endl;
						cin>>quantidade;
						cin>>codigo;

						if(estoque.AdicionarQntUnd(quantidade, codigo)){
							cout << "A quantidade foi acrescentada!" << endl;
						}
						else{
							cout << "Nao foi possivel acrescentar a unidade ao estoque."<< endl;
						}
						system("pause");
						system("cls");
						break;
