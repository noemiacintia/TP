...
void Estoque :: ImprimeUnd( )
{
    for(unsigned i(0); i < CervejaUnidade.size(); i++)
    {
        cout << endl << "*******Dados da " << i+1 << "a Cerveja*******" << endl;
        CervejaUnidade[i].ImprimeUnidade( );
        cout << endl;
    }
}
...
void Estoque :: ImprimeNomeOrdenadoUnd( )
{
    ...
    for(unsigned k(0); k < aux.size(); k++)
    {
        for(unsigned i(0); i < CervejaUnidade.size(); i++)
        {
            ...
            {
                cout << endl <<"*******Dados da " << contador << "a Cerveja*******" << endl;
                CervejaUnidade[i].ImprimeUnidade( );
                cout << endl;
                contador++;
            }
...
void Estoque :: RegraManipulacao( )
{
    ...
    cout<<"> Coloque cada garrafa de cerveja num saco de plastico hermetico;"<<endl;
    cout<<"> Envolva cada uma com plastico-bolha ou espuma para garantir que estejam seguras;"<<endl;
    cout<<"> Se for um pack de cerveja, proteja o pacote inteiro com plastico-bolha;"<<endl;
    cout<<"> Coloque as cervejas numa caixa de cartão ja acolchoada com materiais de amortecimento;"<<endl;
    cout<<"> Preencha os espaços vazios com mais granulado de esferovite ou outro material;"<<endl;
    cout<<"> Feche e sele a caixa. Pode também adicionar uma etiqueta de “Fragil”."<<endl;
}
...
void Estoque :: RegraTransporte( )
{
    ...
    cout<<"> Contar com instalacoes adequadas do local onde a bebida eh fabricada;"<<endl;
    cout<<"> Realizar a higienizacao e manipulacao correta dos ingredientes;"<<endl;
    cout<<"> Manejo de residuos;"<<endl;
    cout<<"> Selecao da materia prima e embalagens;"<<endl;
    cout<<"> Rotulagem;"<<endl;
    cout<<"> Boas praticas protegem quem consome as cervejas."<<endl << endl;
}

// destrutor
Estoque :: ~Estoque( )
{
    CervejaL.clear(); // limpa o vector de objetos
    CervejaUnidade.clear();
}
