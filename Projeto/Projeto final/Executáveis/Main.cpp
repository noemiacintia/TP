...
int main( ){
	...
	cin>>opcao1;
		...
		if(opcao1==1){
			...
			cout<<"2 - Adicionar uma determinada quantidade a um produto existente."<<endl;
			...
			cout <<"Agora, escolha uma das opcoes abaixo: "<<endl;
			cout<<"1 - Inserir uma nova cerveja ao estoque."<<endl;
			cout<<"2 - Adicionar uma determinada quantidade, em litros, a um produto existente."<<endl;
			cout<<"3 - Pesquisar cerveja por nome."<<endl;
			cout<<"4 - Pesquisar cerveja por codigo."<<endl;
			cout<<"5 - Efetuar venda."<<endl;
			cout<<"6 - Remover cerveja por codigo."<<endl;
			...
			system("cls");
				...
				switch(opcao){
					...
					case 5:{
						...
						int quantidade;
						string codigo;
						cout <<	"Entre com a quantidade em litros do produto:"<<endl;
						cin >> quantidade;
						cout<<"Entre com o codigo do produto:"<<endl;
						cin >> codigo;
